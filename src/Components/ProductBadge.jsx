import React from 'react'
 ...
 const ProductBadge = ({badge}) => {
  ...
  if(badge==="choice"){
    ...
    return (<span  className='text-xs xl:text-sm bg-orange-400 text-white p-1'>#1 Best Seller</span>)

  }
  
  else if(badge==="limited"){
    return(<span className='text-xs xl:text-sm bg-orange-400 text-white p-1'>  Limited Time Deal</span>)
